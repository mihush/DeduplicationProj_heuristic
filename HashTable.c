...
long int ht_hashF(HashTableF ht, char *key ) {
    ...
    if(strcmp(key , "c298236f9f") == 0){
        printf("ERROR(2)...\n");
    }
    int table_size = ht->size_table;
